...
class Cuif:
    # Construtor que criar uma imagem CUIF na memória. Os parâmetros são a imagem,
    # a versão CUIF e ids (matrículas dos alunos)
    ...
    # Recebe a imagem e a codifica em CUIF.2. Ou seja, armazenando primeiro os componentes y, depois cb e finalmente cr
    ...
    # Recebe a imagem e a codifica em CUIF.3. Ou seja, converte a imagem em Y,Cb,Cr e depois compacta com RLE
